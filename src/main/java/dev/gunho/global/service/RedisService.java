...
public class RedisService {
    ...
    public List<MapRecord<String, Object, Object>> readAllFromStream(String streamKey) {
        List<MapRecord<String, Object, Object>> allRecords = new ArrayList<>();
        String lastId = "0-0"; // 처음부터
        ...
        while (hasMoreRecords) {
            ...
            if (records.isEmpty()) {
                ...
                lastId = records.get(records.size() - 1).getId().toString(); // 마지막 메시지의 ID로 업데이트
            }
        }
